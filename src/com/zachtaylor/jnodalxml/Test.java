...
public class Test {
  public static void main(String[] args) throws XMLException {
    ...
    n1.setAttribute("n1prop1", "n1prop1val");
    n1.setAttribute("n1prop2", "n1prop2val");

    XMLNode n2 = new XMLNode("child1");
    n2.setAttribute("n2prop1", "n2prop1val");
    n2.setAttribute("n2prop2", "n2prop2val");
    XMLNode n3 = new XMLNode("child2");
    n3.setAttribute("n3prop1", "n3prop1val");
